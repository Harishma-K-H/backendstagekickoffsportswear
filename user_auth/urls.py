...
urlpatterns = [
    path('api/api_branch/',BranchView.as_view(),name='branch_list'),
    path('api/api_branch/details/<int:branch_id>/',BranchDetailView.as_view(),name='branch_list'),
    path("api/token/", login_view.as_view(), name="token_obtain_pair"),
    path("api/token/refresh/", TokenRefreshView.as_view(), name="token_refresh"),
    path('api/district_list/',DistrictList.as_view(),name='district_list'),
    ...
    path('api/customers/<int:customer_id>/', CustomerDetailAPIView.as_view(), name='customer-detail'),
    path('api/state_list/',StateList.as_view(),name='state_list'),
    ...
    path('api/material_list/<int:model_id>/',ModelMaterialList.as_view(),name="model_material"),
