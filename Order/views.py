    ...
    def get(self, request, invoice_id=None, *args, **kwargs):
        try:
            ...
            invoice_data = {
                ...
                "customer":{
                    'custom_id':invoice.order.customer.id,
                    'name':invoice.order.customer.name,
                    'business_name':invoice.order.customer.business_name,
                    'address1':invoice.order.customer.address1,
                    'address2':invoice.order.customer.address2,
                    'mobile_number1':invoice.order.customer.mobile_number1,
                    'mobile_number2':invoice.order.customer.mobile_number2,
                    'email':invoice.order.customer.email,
                    'gst_no':invoice.order.customer.gst_no
